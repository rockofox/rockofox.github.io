...
//offsetTop property returns the top position relative to the parent
  ...
  dragElement(document.querySelector("#homeWindow"), document.querySelector("#homeWindow .titlebar"));
function updateTime() {
   document.getElementsByClassName("time")[0].innerText = new Date().toLocaleTimeString("en-US", {"timeStyle":"short"});
}
setInterval(()=> {
 updateTime();
}, 1000);
